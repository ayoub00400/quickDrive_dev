...
import 'package:taxi_driver/Services/bg_notification_service.dart';
...
Future<void> stopSoundnotificatiion() async {
  await NotificationWithSoundService.player.setReleaseMode(ReleaseMode.stop);
}
