...
class FRideBookingModel {
  ...
  @override
  String toString() {
    return 'FRideBookingModel(riderId: $riderId, driverID: $driverID, rideId: $rideId, status: $status, paymentType: $paymentType, onStreamApiCall: $onStreamApiCall, onRiderStreamApiCall: $onRiderStreamApiCall, tips: $tips, paymentStatus: $paymentStatus)';
  }
}
