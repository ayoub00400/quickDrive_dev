...
import 'package:taxi_driver/app/utils/Extensions/app_common.dart';
...
class RideDetailScreenState extends State<RideDetailScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(riderModel != null ? "${language.ride} #${riderModel!.id}" : "",
      ...
      child: Column(
        ...
        children: [
          ...
          totalCountString(
            ...
            amount: riderModel!.mainPrice,
            space: 8,
          ),
          SizedBox(height: 8),
          totalCountString(
            title: language.platformDeduction,
            amount: subtractStrings(riderModel!.mainPrice ?? '0', riderModel!.finalPrice ?? '0'),
            space: 8,
          ),
          Divider(height: 16, thickness: 1),
          totalCountString(
            title: language.total,
            amount: riderModel!.finalPrice,
            isTotal: true,
          ),
  ...
  String subtractStrings(String number1, String number2) {
          ...
          Row(
            ...
            children: [
              ClipRRect(
                ...
                child: commonCachedNetworkImage(riderModel!.riderProfileImage.validate(),
