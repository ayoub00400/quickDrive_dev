...
import 'package:taxi_driver/app/Services/AuthService.dart';
                  ...
                  steps: [
                            ...
                            if (widget.socialLogin != true)
                              listState.isNotEmpty
                                  ? DropdownButtonFormField<StateModel>(
                                      ...
                                      decoration:
                                          inputDecoration(context, label: ''),
                                      menuMaxHeight:
                                          MediaQuery.of(context).size.height *
                                              0.5,
                                      items: listState.map((e) {
                    ...
                    Step(
                      ...
                      state: currentIndex <= 1
                          ...
                          : StepState.complete,
                      title:
                          Text(language.selectService, style: boldTextStyle()),
                      content: Form(
                        key: formKeys[1],
