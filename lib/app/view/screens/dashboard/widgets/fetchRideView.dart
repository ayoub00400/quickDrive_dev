...
class FetchRideView extends StatelessWidget {
              ...
              if (snapshot.hasData) {
                ...
                if (data.length != 0) {
                  ...
                  if (data[0].onStreamApiCall == 0) {
                    _dashboardController.rideService
                        .updateStatusOfRide(rideID: data[0].rideId, req: {'on_stream_api_call': 1});
                  ...
                  if (controller.servicesListData == null &&
                    ...
                    if (controller.reqCheckCounter < 1) {
                      _dashboardController.rideService
                          .updateStatusOfRide(rideID: data[0].rideId, req: {'on_stream_api_call': 0});
                    }
                  }
                  if ((controller.servicesListData != null &&
                  ...
                  if (controller.servicesListData != null) {
                    return controller.servicesListData!.status != null &&
                            controller.servicesListData!.status == NEW_RIDE_REQUESTED
                                                ...
                                                Padding(
                                                  ...
                                                  child: Column(
                                                    children: [
                                                        ...
                                                        children: [
                                                          ClipRRect(
                                                            ...
                                                            child: commonCachedNetworkImage(
                                                                controller.servicesListData!.riderProfileImage
                                                                    .validate(),
                                                                height: 35,
                                                                width: 35,
                                                                fit: BoxFit.cover),
                                                          ...
                                                          Expanded(
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                SizedBox(height: 4),
                                                                Text(
                                                                    '${controller.servicesListData!.riderEmail.validate()}',
                                                                    maxLines: 1,
                                                                    overflow: TextOverflow.ellipsis,
                                                      ...
                                                      if (controller.estimatedTotalPrice != null &&
                                                          controller.estimatedDistance != null)
                                                        Container(
                                                            ...
                                                            children: [
                                                              Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  SizedBox(width: 4),
                                                                  Text(
                                                                      '${controller.estimatedDistance} ${controller.distance_unit}',
                                                                      maxLines: 1,
                                                                      overflow: TextOverflow.ellipsis,
                                                                      style: boldTextStyle(size: 14)),
                                                                ],
                                                                ...
                                                                Container(
                                                                  ...
                                                                  decoration: BoxDecoration(
                                                                    ...
                                                                    gradient: LinearGradient(
                                                                      colors: [const Color(0xFF417CFF), Colors.white],
                                                                    ...
                                                                    child: AppButtonWidget(
                                                                      ...
                                                                      onTap: () {
                                                                        ...
                                                                        showConfirmDialogCustom(
                                                                            ...
                                                                            context, onAccept: (v) {
                                                                          if (double.tryParse(_dashboardController
                                                                                  .priceController.text) ==
                                                                              null) {
                                                                            toast(language.pleaseEnterValidPrice);

                                                                            return;
                                                                          } else if (int.parse(_dashboardController
                                                                                  .priceController.text) <
  ...
  Positioned ridePopUp(BuildContext context, DashboardController controller) {
    return Positioned(
      bottom: 0,
      child: Container(
        width: MediaQuery.of(context).size.width,
        ...
        child: Column(
          ...
          children: [
                    ...
                    showDialog(
                      ...
                      builder: (_) {
                        return AlertDialog(
                          ...
                          content: AlertScreen(
                              rideId: controller.servicesListData!.id, regionId: controller.servicesListData!.regionId),
                        );
                      },
                    );
                  },
                ...
                inkWellWidget(
                  onTap: () {
                    if (controller.riderData == null ||
                        (controller.riderData != null && controller.riderData!.uid == null)) {
                      init();
            ...
            controller.servicesListData!.status != NEW_RIDE_REQUESTED
                ? Padding(
                    padding: EdgeInsets.only(bottom: controller.servicesListData!.status == IN_PROGRESS ? 0 : 8),
                              ...
                              child: Row(
                                ...
                                children: [
                                  GetBuilder<DashboardController>(
                                      init: DashboardController(),
                                      builder: (controller) {
                                        return controller.extraChargeAmount != 0
                                            ? Text(
