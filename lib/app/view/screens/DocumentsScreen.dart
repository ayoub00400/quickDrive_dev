...
import 'package:taxi_driver/app/view/screens/WaitingScreen.dart';
...
class DocumentsScreenState extends State<DocumentsScreen> {
  ...
  List<DocumentModel> getRemainingDocument() {
    List<DocumentModel> remainingDocument = [];
    documentList.forEach((element) {
      if (!uploadedDocList.contains(element.id)) {
        remainingDocument.add(element);
      }
    });
              ...
              SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    ListView.separated(
                      shrinkWrap: true,
                      itemCount: getRemainingDocument().length,
                      physics: NeverScrollableScrollPhysics(),
                      itemBuilder: (_, index) {
                        return GestureDetector(
                          onTap: () {
                            getMultipleFile(
                              getRemainingDocument()[index].id,
                              null,
                            );
                          },
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                RichText(
                                  text: TextSpan(
                                    text: getRemainingDocument()[index].name!,
