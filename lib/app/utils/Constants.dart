...
const GOOGLE_MAP_API_KEY = 'AIzaSyCtVWA-jMEMBNreZa0MnQoEa4wRxrcoHI0';
//endregion

//region Currency & country code
const currencySymbol = '\$';
const currencyNameConst = 'dzd';
...
const PDF_NAME = 'QuickCargoo Taxi  Private Limited';
const PDF_ADDRESS = 'Sarah Street 9, Beijing, Ahmedabad';
const PDF_CONTACT_NUMBER = '+91 8888888888';
//endregion

//region Walkthrough
const walk_title1 = "العميل ينتظرك!  ";
const walk_desc1 = "شكرًا لاختيارك لنا";

const walk_title2 = "شريكك الآمن في النقل";
const walk_desc2 = "دعنا نبدأ رحلتك بأمان وثقة";

const walk_title3 = "تتبع زبونك";
const walk_desc3 = "خطوة بخطوة حتى الوصول";
//endregion
