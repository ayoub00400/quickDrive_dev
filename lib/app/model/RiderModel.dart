...
import 'package:taxi_driver/app/model/CouponData.dart';
import 'package:taxi_driver/app/model/ExtraChargeRequestModel.dart';
...
class RiderModel {
  ...
  @override
  String toString() {
    return 'RiderModel(amount: $amount, baseFare: $baseFare, cancelBy: $cancelBy, canceLationCharges: $canceLationCharges, coupon: $coupon, couponData: $couponData, createdAt: $createdAt, datetime: $datetime, distance: $distance, driverId: $driverId, driverName: $driverName, driverProfileImage: $driverProfileImage, duration: $duration, endAddress: $endAddress, endLatitude: $endLatitude, endLongitude: $endLongitude, endTime: $endTime, extraCharges: $extraCharges, id: $id, isDriverRated: $isDriverRated, isRiderRated: $isRiderRated, isSchedule: $isSchedule, maxTimeForFindDriverForRideRequest: $maxTimeForFindDriverForRideRequest, minimumFare: $minimumFare, otp: $otp, paymentId: $paymentId, paymentStatus: $paymentStatus, paymentType: $paymentType, perDistance: $perDistance, perMinuteDrive: $perMinuteDrive, reason: $reason, rideAttempt: $rideAttempt, riderId: $riderId, riderName: $riderName, riderEmail: $riderEmail, riderProfileImage: $riderProfileImage, seatCount: $seatCount, serviceId: $serviceId, startAddress: $startAddress, startLatitude: $startLatitude, startLongitude: $startLongitude, startTime: $startTime, status: $status, subtotal: $subtotal, totalAmount: $totalAmount, updatedAt: $updatedAt, waitingTime: $waitingTime, waitingTimeCharges: $waitingTimeCharges, perMinuteWaiting: $perMinuteWaiting, distanceUnit: $distanceUnit, couponDiscount: $couponDiscount, perMinuteWaitingCharge: $perMinuteWaitingCharge, perMinuteDriveCharge: $perMinuteDriveCharge, perDistanceCharge: $perDistanceCharge, driverContactNumber: $driverContactNumber, riderContactNumber: $riderContactNumber, extraChargesAmount: $extraChargesAmount, otherRiderData: $otherRiderData, tips: $tips, shipmentType: $shipmentType)';
  }
}
