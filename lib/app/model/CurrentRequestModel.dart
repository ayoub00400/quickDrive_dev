...
class OnRideRequest {
  ...
  @override
  String toString() {
    return 'OnRideRequest(id: $id, riderId: $riderId, serviceId: $serviceId, datetime: $datetime, isSchedule: $isSchedule, rideAttempt: $rideAttempt, otp: $otp, totalAmount: $totalAmount, subtotal: $subtotal, extraChargesAmount: $extraChargesAmount, driverId: $driverId, driverName: $driverName, riderName: $riderName, driverProfileImage: $driverProfileImage, riderProfileImage: $riderProfileImage, startLatitude: $startLatitude, startLongitude: $startLongitude, startAddress: $startAddress, endLatitude: $endLatitude, endLongitude: $endLongitude, endAddress: $endAddress, distanceUnit: $distanceUnit, startTime: $startTime, endTime: $endTime, distance: $distance, duration: $duration, seatCount: $seatCount, reason: $reason, status: $status, baseFare: $baseFare, minimumFare: $minimumFare, perDistance: $perDistance, perMinuteDrive: $perMinuteDrive, perMinuteWaiting: $perMinuteWaiting, waitingTime: $waitingTime, waitingTimeLimit: $waitingTimeLimit, waitingTimeCharges: $waitingTimeCharges, cancelationCharges: $cancelationCharges, cancelBy: $cancelBy, paymentId: $paymentId, paymentType: $paymentType, paymentStatus: $paymentStatus, extraCharges: $extraCharges, couponDiscount: $couponDiscount, couponCode: $couponCode, couponData: $couponData, isRiderRated: $isRiderRated, isDriverRated: $isDriverRated, maxTimeForFindDriverForRideRequest: $maxTimeForFindDriverForRideRequest, createdAt: $createdAt, updatedAt: $updatedAt, driverContactNumber: $driverContactNumber, riderContactNumber: $riderContactNumber, driverEmail: $driverEmail, riderEmail: $riderEmail, regionId: $regionId, isRideForOther: $isRideForOther, otherRiderData: $otherRiderData, shipmentType: $shipmentType)';
  }
}
