...
//   @override String get waitingForDriverConformation => '라이더 확인을 기다리는 중';
...
//   @override
//   String get chooseMap => '지도 선택';
//   @override String get rideFor => '을 위한 타기';
//   @override String get updateVehicleInfo => '차량 정보 업데이트';
//   @override String get ridingPerson => '타는 사람';
//   @override String get writeReasonHere => '여기에 이유를 적어주세요..';
//   @override String get cancelRide => '탑승 취소';
//   @override String get riderNotAnswer => '승객이 응답하지 않음';
//   @override String get accidentAccept => '실수로 여행을 수락했습니다.';
//   @override String get riderNotOnTime => '라이더가 제시간에 나타나지 않았습니다';
//   @override String get vehicleProblem => '차량 문제';
//   @override String get paymentSuccess => '결제 성공';
//   @override String get estAmount => '추정 금액';
//   @override String get dontFeelSafe => '나는 안전하다고 느끼지 않는다';
//   @override String get wrongTurn => '방향을 잘못 잡았어요';
//   @override String get cancelledReason => '취소 사유';
//   @override String get rideCanceledByRider => '라이더가 라이드를 취소했습니다.';
...
//   @override String get riderReview=> "라이더 리뷰";
//   @override String get fileSizeValidate => '최대 업로드 크기: 2MB';
//   @override String get fileSizeValidateMsg => '파일이 너무 커서 업로드할 수 없음';
